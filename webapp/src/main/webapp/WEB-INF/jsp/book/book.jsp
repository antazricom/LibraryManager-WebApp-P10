                        ...
                        <article>
                            ...
                            <div class="menu">
                                <ul class="menu-list">
                                    ...
                                    <li class="list-content"><a disabled="disabled">Publié en : ${book.publicationDate.getYear()}</a></li>
                                    ...
                                    <li class="list-content"><a disabled="disabled">Nombre de copies : ${book.copies}</a></li>
                                    <li class="list-content"><a disabled="disabled">Nombre de copies disponibles : ${copiesAvailable}</a></li>
                                </ul>
                            </div>
